...
else if(poleo[1]+poleo[2]+poleo[3]+poleo[4]+poleo[5]+poleo[6]+poleo[7]+poleo[8]+poleo[9]+polex[1]+polex[2]+polex[3]+polex[4]+polex[5]+polex[6]+polex[7]+polex[8]+polex[9] == 9 || poleo[1]+poleo[2]+poleo[3]+poleo[4]+poleo[5]+poleo[6]+poleo[7]+poleo[8]+poleo[9]+polex[1]+polex[2]+polex[3]+polex[4]+polex[5]+polex[6]+polex[7]+polex[8]+polex[9] == 10)
{
polex[1] = 0;
polex[2] = 0;
polex[3] = 0;
